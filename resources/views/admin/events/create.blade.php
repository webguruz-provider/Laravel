...
@section('content')
	...
	<div class="admin-content__body u-background-light">
		...
		<div class="admin-content__form">
			<form method="POST" action="/partners/events/store" enctype="multipart/form-data" class="create-ad-btn"> 
				<div class="field field-err">
                <div class="field-inner">
					<input type="text" name="name" class="form-control ad-textbox" v-model="form.name" placeholder="Name Your event…">
    		...
    		@endif
				...
				<div class="ranged">
					<div class="field field__left field-err">
						...
						<p class="field-description">Select all topics that apply.</p>
						<input type="text" name="publish_at" class="form-control" data-calendar-start v-model="form.publish_at" placeholder="Choose a date to publish your event">
					...
					<div class="field field__right field-err">
						...
						<p class="field-description">Select all topics that apply.</p>
						<input type="text" name="expire_at" class="form-control" data-calendar-end v-model="form.expire_at" placeholder="Choose a date to expire your event">
				...
				<div class="field-group">
					<button class="btn btn-green" type="submit" name="status" value="live">Create event</button>
				</div>
