...
@section('content')
 <header class="admin-content__header u-bg-white">
	...
	<div class="admin-content__body u-background-light">
		<section class="admin-content__section"><div class="admin-content__section-header"><div><h3 class="admin-content__section-headline">Explore data of all Draft Categories</h3> <p class="admin-content__section-desc">
