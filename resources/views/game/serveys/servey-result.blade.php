        ...
        <div class="col-lg-12">
			...
			<div class="custom-inner {{$newClass}}">
                ...
                @if($questionDetails->allowed_other_answer == 1)
                    <div class="bar">
                        <div class="value tooltips" data-original-title="{{ $otherAnswersCount }}%" data-toggle="tooltip" data-placement="top" style="height: {{ $otherAnswersCount*$heightMultipliyer }}%; background-color:#ff00bf;" onclick='resultDetail("Other Answer", {{ $otherAnswersCount }}, {{ ($otherAnswersCount / $answered)*100 }})'></div>
                    </div>
                @endif
            </div>
			</div>
