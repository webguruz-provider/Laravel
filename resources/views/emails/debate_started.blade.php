        ...
        <table cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                ...
                $question_name = DB::table('questions')
                        ...
                        ->where('debates.id', $debate->id)
                        ->first();
                ?>
                                    <tr>
                                        <td style="font-family: sans-serif; font-weight: bold; font-size: 21px; mso-height-rule: exactly; line-height: 24px; color: #333333; padding: 0 10px 10px; text-align: center;" class="center-on-narrow"><p><span style="font-family: sans-serif; font-weight: bold; font-size: 21px; mso-height-rule: exactly; line-height: 24px; color: #333333; padding: 0 10px 10px; text-align: center;" class="center-on-narrow">Hi {{ucfirst(trans($user->name))}}, do you want to start a debate about <a href="{{ route('publicDebateShow', $debate->id)}}" style="color: #61dd50; text-decoration: none;">{{ $question_name->name }}</a> on <a href="https://beta.sided.co" style="color: #61dd50; text-decoration: none;">Sided.</a></span></p></td>
                                    </tr>
                                    <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                        <tr>
                            <td style="border-radius: 3px; background: #61dd50; text-align: center;" class="button-td">
                                <a href="{{ route('publicDebateShow', $debate->id)}}" style="background: #61dd50; border: 15px solid #61dd50; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#ffffff">Start this Debate</span>&nbsp;&nbsp;&nbsp;&nbsp;</a>
                            </td>
                        </tr>
                    </table><br />
