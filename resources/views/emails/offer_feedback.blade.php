...
<body bgcolor="#f0f0f0" width="100%" style="margin: 0;">
    <center style="width: 100%; background: #f0f0f0;">
        ...
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
            {{$pro_email}} propose a suggestion
        </div>
                            ...
                            <td class="stack-column-center">
                                <table cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr>
										...
										Here are all the Details-<br /><br />
										Subject- {{$subjectbyuser}} <br />
                                            Feedback Text- {{$feedback_text}} <br /><br />
