      ...
      <table cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                <td style="padding: 20px 0; text-align: center">
                    <img src="{{ asset('emails/SidedLogoOneColor_200x25.png') }}" width="200" height="50" alt="alt_text" border="0">
                </td>
            </tr>
        </table>
        <!-- Email Header : END -->
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 10px; text-align: center">
                                           <a href="https://beta.sided.co"> <img src="{{ asset('emails/openicon.png') }}" width="90" height="90" alt="alt_text" border="0" class="fluid"></a>
                                        </td>
                                    </tr>

                                    <tr>
                                        <td style="font-family: sans-serif; font-weight: bold; font-size: 21px; mso-height-rule: exactly; line-height: 24px; color: #333333; padding: 20px 10px 0px 10px; text-align: center;" class="center-on-narrow"><!--td {border: 1px solid #ccc;}br {mso-data-placement:same-cell;}-->
                                        <span data-sheets-value="{'1':2,'2':'Did you forget your Sided Password?'}" data-sheets-userformat="{'2':29569,'3':{'1':0},'10':0,'11':4,'12':0,'15':'Arial','16':9,'17':1}">Did you forget your Sided Password?<br />
                                        <br />
                                        </span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 0 10px 10px; text-align: center;" class="center-on-narrow">
                                            <p>Hi {{ ucfirst(trans($notifiable->name)) }}, we recently received a request to change the password on your Sided account. If you requested this password change, please set a new password by clicking the reset button below.<br />
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                        <tr>
                            <td style="border-radius: 3px; background: #61dd50; text-align: center;" class="button-td">
                                <a href="{{ $actionUrl }}" style="background: #61dd50; border: 15px solid #61dd50; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
...
<a href="{{ $actionUrl }}"  style="color: #999999; font-size: 12px; text-decoration: none;">{{ $actionUrl }}</a>

                                          <br />
                                          <br />
                                          If you don't want to change your password, then just ignore this message. For your account safety, the link expires in 24 hours at {{ $expireTime }}.                                          </p>
                                            <p><br />
                                          </p></td>
                                    </tr>
                                </table>
